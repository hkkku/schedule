  ...
  <div class="cateTabs">
    ...
    <a href="/myschedule/pages/sch_view.php?key=view_api"><i class="fa fa-cloud-download-alt"></i></a>
    <a href="/myschedule/pages/sch_view.php?key=view_renewal" class="active"><i class="fa fa-copy"></i></a>
