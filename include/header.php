   ...
   <a href="/myschedule/php/sign_out.php"><i class="fa fa-sign-out-alt"></i></a> 
    ...
    <div class="hiddenHeader">
      <ul class="depth-1">
        ...
        <li><a href="/myschedule/pages/input_form.php"><i class="fa fa-pencil-alt"></i></a></li>
        <li>
          <a href="/myschedule/pages/sch_view.php?key=view_all"><i class="fa fa-check-square"></i></a>
        </li>
      </ul>
    </div>
  </div>
